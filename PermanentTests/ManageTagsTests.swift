...
class ManageTagsTests: XCTestCase {
    ...
    /// Captured so tearDown restores the process-wide session: the mock installed below carries a mock
    /// account, and leaving it behind leaks that name into unrelated tests.
