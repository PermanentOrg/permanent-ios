...
class FailedVerificationCodeTestURLs: TestURLs {
    override var urls: [URL? : Data] {
        return [
            URL(string: "https://www.permanent.org/api/auth/verify"): "{\"Results\":[{\"data\":null,\"message\":[\"warning.auth.token_does_not_match\"],\"status\":false,\"resultDT\":\"2021-07-27T22:26:39\",\"createdDT\":null,\"updatedDT\":null}],\"isSuccessful\":false,\"actionFailKeys\":[0],\"isSystemUp\":true,\"systemMessage\":\"Everything is A-OK\",\"sessionId\":null,\"createdDT\":null,\"updatedDT\":null}".data(using: .utf8)!
        ]
    }
}
