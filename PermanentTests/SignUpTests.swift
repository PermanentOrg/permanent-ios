...
class FailedSignUpTestURLs: TestURLs {
    override var urls: [URL? : Data] {
        return [
            URL(string: "\(APIEnvironment.defaultEnv.baseURL)/account/post"): "{\"Results\":[{\"data\":null,\"message\":[\"warning.registration.duplicate_email\"],\"status\":false,\"resultDT\":\"2021-07-26T13:59:05\",\"createdDT\":null,\"updatedDT\":null}],\"isSuccessful\":false,\"actionFailKeys\":[0],\"isSystemUp\":true,\"systemMessage\":\"Everything is A-OK\",\"sessionId\":null,\"createdDT\":null,\"updatedDT\":null}".data(using: .utf8)!
        ]
    }
}
