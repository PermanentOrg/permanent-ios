...
struct Text {
    ...
    static var style17 = TextStyle(UIFont(name: "OpenSans-SemiBold", size: 16)!, TextStyle.calculateSpacing(fontSize: CGFloat(16), lineHeight: CGFloat(22)), NSTextAlignment.natural)
