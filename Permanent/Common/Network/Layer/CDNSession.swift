...
//  Permanent
//
//  Created by Vlad & Lucian on 28/07/2021.
//

import Foundation

class CDNSession: NSObject {
    ...
    private func setHandlers(_ handlers: ProgressAndCompletionHandlers?, for task: URLSessionTask) {
        ...
        if let handlers = handlers {
            ...
            taskToHandlersMap.removeValue(forKey: task)
        }
    }
...
extension CDNSession: URLSessionTaskDelegate {
...
extension CDNSession: URLSessionDownloadDelegate {
...
extension CDNSession: NetworkSessionProtocol {
